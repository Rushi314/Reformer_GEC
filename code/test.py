...
def main(args):
    file_path = "/content/gdrive/Shareddrives/CS685_Reformer_GEC/Data/bea19_fixed.txt"  # Add a path to file from which data is to be read.
    pred_file_path = "/content/gdrive/Shareddrives/CS685_Reformer_GEC/Data/bea19_pred.txt"  # Add a path to file where the prediction should be written.
    ...
    data_loader = DataLoader(test_data, batch_size=1)  # Can change the batch size later
